...
- [ x ] **Schedule Navigation:** Implement logic to navigate between weeks (Previous/Next) in the Schedule view. Currently, it only shows the current week, making past workouts inaccessible.
...
- [ x ] **CRUD Actions:** Add "Edit" and "Delete" functionality to `RaceCard` and `WorkoutCard`.
